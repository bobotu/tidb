...
type Performance struct {
	...
	EnableTxnBufferOffHeapAlloc bool    `toml:"enable-txn-buffer-off-heap-alloc" json:"enable-txn-buffer-off-heap-alloc"`
...
var defaultConf = Config{
	...
	Performance: Performance{
		MaxMemory:             0,
		ServerMemoryQuota:     0,
		MemoryUsageAlarmRatio: 0.8, TCPKeepAlive: true,
		CrossJoin:                   true,
		StatsLease:                  "3s",
		RunAutoAnalyze:              true,
		StmtCountLimit:              5000,
		...
		EnableTxnBufferOffHeapAlloc: true,
		DistinctAggPushDown:         false,
		CommitterConcurrency:        16,
		MaxTxnTTL:                   60 * 60 * 1000, // 1hour
		MemProfileInterval:          "1m",           // TODO: set indexUsageSyncLease to 60s.
